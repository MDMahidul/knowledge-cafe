...
const SingleCard = ({article,handleBookMarked,handleReadingTime}) => {
          ...
          <div className="card-body">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <div>
                ...
                <a href="#" onClick={() => handleBookMarked(id)}>
                  <FontAwesomeIcon className="b-icon" icon={faBookmark} />
                </a>
              </div>
            </div>
            <div>
              ...
              <a
                className="mt-3"
                href="#"
                onClick={()=>handleReadingTime(article.readTime)}
              >
                Mark as read
              </a>
            </div>
